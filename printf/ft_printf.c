...
/*   Updated: 2021/12/01 15:39:59 by gseco-lu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <stdarg.h>
#include <unistd.h>
	...
	while (i < linelen)
	{
		if (str[i] == '%')
		{
			...
			if (str[i + 1] == 'p')
			{
				...
				ft_re_address(((unsigned long int)&q), 1);
				i = i + 2;
			}
		}
		else
...
int main()
{
	char *ptr3 = "dded4543653ioewo";
	ft_printf("owjsoqdj %c ewj %% uh %p cw %d owdjo %s\n", 'n', ptr3, 290207389, "dqodiodsaiod23981482ew");
ft_printf("owjsoqdj %c ewj %% uh %p cw %d owdjo %s\n", 'n', ptr3, 290207389, "dqodiodsaiod23981482ew");
