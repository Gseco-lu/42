...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/14 14:21:36 by gseco-lu          #+#    #+#             */
/*   Updated: 2023/06/14 14:21:36 by gseco-lu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string namee) : name(namee), hitPoints(10), energyPoints(10), attackDamage(0), maxHealth(10)
{
	std::cout << "\033[31m" << "ClapTrap " << name << " was created"  << "\033[37m" << std::endl;
}

ClapTrap::ClapTrap(ClapTrap const &C) : name(C.name), hitPoints(C.hitPoints), energyPoints(C.energyPoints), attackDamage(C.attackDamage), maxHealth(C.maxHealth)
{
